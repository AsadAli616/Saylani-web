...
import { createBrunch } from "../../service/userAction"; // import your API function

const CreateLunch = NiceModal.create(({ id, setbutton, button }) => {
  ...
  const onSubmit = async (values) => {
    ...
    console.log("obj=>", obj);
    const { data } = await createBrunch(obj);
