...
import { createDinner } from "../../service/userAction"; // import your API function

const CreateDinner = NiceModal.create(({ id, setbutton, button }) => {
  ...
  const onSubmit = async (values) => {
    ...
    console.log("obj=>", obj);
    const { data } = await createDinner(obj);
